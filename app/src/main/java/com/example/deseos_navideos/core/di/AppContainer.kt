...
import com.example.deseos_navideos.core.hardware.data.AndroidVibrationService
...
class AppContainer(context: Context) {
    ...
    val vibrationService: VibrationService by lazy {
        AndroidVibrationService(context)
    }
    ...
    private val retrofit: Retrofit = Retrofit.Builder()
        .baseUrl("http://100.50.208.4/") // Using 10.0.2.2 for emulator localhost
        .client(client)
